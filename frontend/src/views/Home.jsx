...
export default function Home() {
  ...
  // No device pedometer to read (openGym stays dependency-light, and the web build has no
  // step-counting API to read from anyway) — so this totals today's distance-tagged events
  // instead of asking you to type a number. lib/events.js eventSteps() per event.
  const todaySteps = (S.events || []).filter(e => e.d === todayISO()).reduce((n, e) => n + eventSteps(e), 0)
