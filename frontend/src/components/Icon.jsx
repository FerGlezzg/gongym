...
const P = {
  ...
  /* ---- objects ---- */
  // Apple — the Diet tab. Two lobes for the body, a short stem and a leaf.
  apple: <><path d="M12 8.2c-1.1-1.7-3-2.2-4.5-1.2-1.9 1.2-2.3 4.1-1.1 6.8.8 1.9 2.1 3.8 3.4 4.8 1.1.9 2.9.9 4 0 1.3-1 2.6-2.9 3.4-4.8 1.2-2.7.8-5.6-1.1-6.8-1.5-1-3.4-.5-4.5 1.2Z" /><path d="M12 8.2V4.6M12 5.6c1-1.4 2.7-1.9 4-1.5.1 1.3-.8 2.9-2.4 3.3" /></>,
